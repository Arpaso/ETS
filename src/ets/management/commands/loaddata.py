...
class Command(BaseCommand):
    ...
    option_list = BaseCommand.option_list + (
        ...
        make_option('--not_check_constraints', action='store_false', dest='check_constraints',
            help='check constraints or not'),
    )
    ...
    def handle(self, *fixture_labels, **options):
        ...
        check_constraints = options.get('check_constraints', True)
